        ...
        <div class="row">
            ...
            <table class="table table-dark">
                ...
                <tr>
                                    ...
                                    <td><a class="text-white"href="CompanyRemoved?name=<%=name%>"><%=name%></a></td>
                                    <td><a class="text-white"href="#"><%=date%></a></td>
                                    <td><a class="text-white"href="#"><%=type%></a></td>
                                    <td><button type="button" class="close text-white" aria-label="Close"><a class="text-white" href="CompanyRemoved?name=<%=name%>">
