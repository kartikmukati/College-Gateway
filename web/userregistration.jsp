...
<body class="form-v10">
	<div class="page-content">
		<div class="form-v10-content">
			<form class="form-detail" action="UserRegistration" method="post" id="myform">
				<div class="form-left">
                    ...
                    <div class="form-row">
                            <input type="text" name="enrollmentno" class="company" id="company" placeholder="Enrollment No" required>
                   </div>
					<div class="form-row">
						<select name="gender">
			...
			<span class="select-btn">
				...
				<div class="form-right">
                    ...
                    <div class="form-row form-row-2">
							<input type="text" name="contactno" class="phone" id="phone" placeholder="Phone Number" required>
					</div>
					<div class="form-row">
