        ...
        <div class="row">
            ...
            <table class="table table-hover">
                ...
                <tr>
                                    ...
                                    <td><a class="text-dark"href="UpdateCompanyDetails?name=<%=name%>"><%=name%></a></td>
                                    <td><a class="text-dark"href="#"><%=date%></a></td>
                                    <td><a class="text-dark"href="#"><%=type%></a></td>
                                </tr>    
                <%
                                counter++;
                               }
